...
class Detuner(tf.keras.Model): # <--- CAMBIO 2: Ahora es Model
    def __init__(self):
        super().__init__()
...
if __name__ == "__main__":
    ...
    CARPETA_PESOS = os.path.join(BASE_DIR, "checkpoints_descargados") 
    SALIDA_WAV = os.path.join(BASE_DIR, "resultado_ddsp_reverb.wav")
